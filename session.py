...
while True:
 try:
  with TelegramClient(StringSession(), API_KEY, API_HASH) as client:
   ...
   print(
       "Thanks for Choosing pemulung-userbot Have A Good Time....Note That When You Terminate the Old Session ComeBack And Genrate A New String Session Old One Wont Work"
   )
